...
--experiment_name casprpp_fastmri_experiment \
--num_studies 3 \
--num_tuning_trials 5 \
--seed 10 \
...
--docker_image_url "us-central1-docker.pkg.dev/training-algorithms-external/mlcommons-docker-repo/algoperf_both_main" --local --workload "fastmri"
